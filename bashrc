...
PROMPT_COMMAND='PS1="(VM) - ${c_user}\u${c_reset}:${c_path}\w ($(rvm-prompt))${c_reset}$(git_prompt)\$ "'
...
alias runm3='m3 && rails server -p3001'
alias runapi='api && rails server -p3003'
alias runua='ua && rails server'
